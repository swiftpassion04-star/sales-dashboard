...
def save_lead_followup(customer: pd.Series, values: dict) -> str | None:
    ...
    payload = {
        ...
        "crm_data_import_id": first_value(customer, "id", "customer_id"),
        "order_id": first_value(customer, "order_id"),
        ...
        "product_name": first_value(customer, "product_name", "product"),
        "sku": first_value(customer, "sku"),
        "staff_code": first_value(customer, "staff_code"),
        "owner": first_value(customer, "sales_staff", "owner"),
        "lead_status": values["lead_status"],
        "followup_status": values["follow_up_status"],
        "next_followup_date": values["follow_up_date"].isoformat() if values.get("follow_up_date") else None,
        "followup_note": values.get("follow_up_note", ""),
